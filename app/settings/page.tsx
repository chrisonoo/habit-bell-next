...
const SessionDurationSlider = dynamic(
    () =>
        import("@/components/settings/SessionDurationSlider").then(
            (mod) => mod.SessionDurationSlider
        ),
    { ssr: false }
);

const IntervalRangeSlider = dynamic(
    () =>
        import("@/components/settings/IntervalRangeSlider").then(
            (mod) => mod.IntervalRangeSlider
        ),
    { ssr: false }
);
